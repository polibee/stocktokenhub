...
- Complete the [Basics Tutorial](/blog/basics/tutorial-basics)
...
**Next Step**: You can continue learning the [Decentralized Exchange Tutorial](/blog/trading/tutorial-dex) to understand more trading methods.